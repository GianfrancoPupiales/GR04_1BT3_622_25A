            ...
            <form class="row g-3 align-items-center mb-3" action="ManageProductsController" method="get">
                ...
                <div class="col-auto">
                    <select class="form-select" name="category" id="category">
                        ...
                        <option value="Stationery" ${selectedCategory == 'Stationery' ? 'selected' : ''}>Stationery
                        </option>
                        <option value="Electronics" ${selectedCategory == 'Electronics' ? 'selected' : ''}>Electronics
                        </option>
                        <option value="Furniture" ${selectedCategory == 'Furniture' ? 'selected' : ''}>Furniture
                        </option>
                        ...
                        <option value="Entertainment" ${selectedCategory == 'Entertainment' ? 'selected' : ''}>
                            Entertainment
                        </option>
                        <option value="Food" ${selectedCategory == 'Food' ? 'selected' : ''}>Food</option>
                        <option value="Transport" ${selectedCategory == 'Transport' ? 'selected' : ''}>Transport
                        </option>
                                ...
                                <div class="flex-grow-1 pe-3">
                                    <h3 class="card-title fw-bold">
                                        <a class="text-dark text-decoration-underline"
                                           href="${pageContext.request.contextPath}/MakeOfferController?route=select&view=product&id=${product.idProduct}">
                                                ${product.title}
                                        </a>
                                    </h3>
                                    <c:choose>
